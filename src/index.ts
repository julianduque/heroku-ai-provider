...
export interface HerokuProviderSettings {
  chatApiKey?: string; // Defaults to process.env.HEROKU_INFERENCE_KEY
  embeddingsApiKey?: string; // Defaults to process.env.HEROKU_EMBEDDING_KEY
  chatBaseUrl?: string; // Defaults to process.env.HEROKU_INFERENCE_URL or fallback URL
  embeddingsBaseUrl?: string; // Defaults to process.env.HEROKU_EMBEDDING_URL or fallback URL
}
