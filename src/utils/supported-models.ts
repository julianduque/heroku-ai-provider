 ...
 */
export const SUPPORTED_CHAT_MODELS: readonly string[] = Object.freeze([
  "claude-3-5-haiku",
 ...
 */
export const SUPPORTED_EMBEDDING_MODELS: readonly string[] = Object.freeze([
...
export async function fetchAvailableModels(options?: {
  ...
  try {
    ...
    const data = (await response.json()) as HerokuModelInfo[];
 ...
 */
export function getSupportedChatModelsString(): string {
 ...
 * @returns Comma-separated list of supported models
 */
export function getSupportedEmbeddingModelsString(): string {
