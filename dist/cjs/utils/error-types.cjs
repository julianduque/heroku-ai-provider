...
exports.ERROR_METADATA = exports.ErrorCategory = exports.ErrorSeverity = exports.HTTP_STATUS_TO_ERROR_TYPE = exports.HerokuErrorType = void 0;
...
})(HerokuErrorType || (exports.HerokuErrorType = HerokuErrorType = {}));
/**
 ...
 */
function getErrorMetadata(errorType) {
    return (exports.ERROR_METADATA[errorType] || exports.ERROR_METADATA[HerokuErrorType.UNKNOWN_ERROR]);
}
/**
