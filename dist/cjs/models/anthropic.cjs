...
exports.HerokuAnthropicModel = void 0;
...
class HerokuAnthropicModel {
    ...
    validateConstructorParameters(model, apiKey, baseUrl) {
        ...
        if (!supported_models_js_1.SUPPORTED_ANTHROPIC_MODELS.includes(model)) {
    ...
    async doStream(options) {
        ...
        try {
            ...
            const rawStream = (0, api_client_js_1.processAnthropicStream)(response, this.baseUrl);
        ...
        switch (event.type) {
            ...
            case "content_block_stop": {
                ...
                if (block && block.type === "tool_use" && block.name) {
                    ...
                    parts.push({
                        type: "tool-call",
                        toolCallId: block.id || (0, provider_utils_1.generateId)(),
                        toolName: block.name,
                        input,
                    });
                }
...
exports.HerokuAnthropicModel = HerokuAnthropicModel;
